...
$(document).ready(function () {
    ...
    // Collection page scrips

    // Shows associalted nutritional information on product titles
    $('.order-variant').hover(function () {
        var hoverNutritionID = $(this).data('id');

        $('.image-wrapper .nutrition').removeClass('show');

        $('#' + hoverNutritionID).addClass('show');
    });
    $('.order-buttons').mouseleave(function () {
        $('.image-wrapper .nutrition').removeClass('show');
    });
    ...
    $('.variant-add').on('click', function () {
        ...
        var parentProduct = $(this).data('parent');

        $('#' + parentProduct).addClass('adding');
        setTimeout(function () {
            $('#' + parentProduct).removeClass('adding');
        }, 1500);
    ...
    $('.sidebar-trigger').on('click', function () {
        $('.collection__sidebar').addClass('sidebar--visible');
    });

    $('.sidebar-hide').on('click', function () {
        $('.collection__sidebar').removeClass('sidebar--visible');
    });
...
$(document).ready(function () {
    ...
    var stickyNavTop = $siteHeader.offset().top;
    ...
    var stickyNav = function () {
        ...
        if (scrollTop > 100) {
            ...
            $siteHeader.parent().css('padding-top', siteHeaderHeight);

        } else {
            $siteHeader.removeClass('sticky');
            $siteHeader.parent().css('padding-top', 0);
...
var $jq = jQuery.noConflict();
    $jq('.image-wrapper--has-popup').featherlight({
    ...
    $jq( ".product-tile" ).hover(
      function() {
        $(this).parent().parent().find(".image-container--overlay").css("opacity",".0");
      }, function() {
        $(this).parent().parent().find(".image-container--overlay").css("opacity","0");
      }
    );
